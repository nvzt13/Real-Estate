...
const MapView = ({ selectedListing }: { selectedListing: Listing[] }) => {
  ...
  const center: [number, number] =
    ...
    Array.isArray(selectedListing[0].coordinates) &&
    selectedListing[0].coordinates.length === 2
    ...
    <Container fluid className="p-0">
      ...
      <Container className="my-3">
        ...
        <Row className="align-items-center mb-3">
          ...
          >
            <Button variant="outline-secondary" className="me-2 active">
              Tümü
            </Button>
      ...
      <Container className="my-4">
        <Card
          className="text-center p-0 border-0 shadow-sm"
          ...
          {listings.map((item, index) => (
            <Col key={index} xs={12} md={4} lg={3} className="mb-3">
              <Card className="text-center p-3">
                <div
                  className="rounded-circle bg-primary text-white d-inline-flex align-items-center justify-content-center mb-2 mx-auto"
