...
const items = [
  {
    ...
    type: "Ev",
    image:
      "https://images.unsplash.com/photo-1580273916550-e323be2ae537?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8Y2FyfGVufDB8fDB8fHww",
  },
  {
    id: 2,
...
export default function Home() {
  return (
    <div className="home container">
      ...
      <Listings />
      {/* This component is used to fill the Redux store with initial data */}
      <FillReduxStore />
    </div>
  );
}
