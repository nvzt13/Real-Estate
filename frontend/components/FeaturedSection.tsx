          ...
          <div className="row">
            <div className="col-lg-4">
              <div className="left-image">
                <img src="/featured.jpg" alt="Featured property" />
            ...
            <div className="col-lg-3">
              <div className="info-table">
                <ul>
                  <li>
                    <img src="/info-icon-01.png" alt="" style={{ maxWidth: '52px' }} />
                    <h4>250 m2<br /><span>Total Flat Space</span></h4>
                  </li>
                  <li>
                    <img src="/info-icon-02.png" alt="" style={{ maxWidth: '52px' }} />
                    <h4>Contract<br /><span>Contract Ready</span></h4>
                  </li>
                  <li>
                    <img src="/info-icon-03.png" alt="" style={{ maxWidth: '52px' }} />
                    <h4>Payment<br /><span>Payment Process</span></h4>
                  </li>
                  <li>
                    <img src="/info-icon-04.png" alt="" style={{ maxWidth: '52px' }} />
